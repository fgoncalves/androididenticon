package com.github.fgoncalves.androididenticon.identicon
...
interface Identicon {
     ...
     */
    fun generate(text: String, bitmapSizePx: Int = 250): Single<Bitmap>
}

class IdenticonImpl : Identicon {
    override fun generate(text: String, bitmapSizePx: Int): Single<Bitmap> =
